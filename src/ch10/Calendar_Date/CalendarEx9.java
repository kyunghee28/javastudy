...
public class CalendarEx9 {
    public static void main(String[] args) {
        System.out.println("2022. 5. 1 : " + getDayOfWeek(2022, 5, 1));
        System.out.println("2022. 6. 1 : " + getDayOfWeek(2022, 6, 1));
        System.out.println("2022. 5.  1- 2022. 4. 28 :"+dayDiff(2022, 5, 1, 2022, 4, 28));
        System.out.println("2022. 6. 29 : " + convertDateToDay(2022, 6, 29));
        System.out.println("738335 : " + convertDayToDay(738335));
    }
    // 각 달의 마지막 일
