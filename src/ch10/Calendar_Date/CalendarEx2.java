...
public class CalendarEx2 {
    public static void main(String[] args) {
        ...
        date1.set(2021, 7, 15); // 2021년 8월 15일로 날짜를 설정한다.
...
// 실행 결과
/*
date1은 2021년 8월 15일 일요일이고,
오늘(date2)은 2022년 5월 29일 일요일입니다.
그 날(date1) 부터 지금(date2) 까지  24796800초가 지났습니다.
일(day) 로 계산하면 287일 입니다.
*/
